...
const runnable_agent = RunnableSequence.from([
  {
    input: (i) => i.input,
    conversation_history: (i) => formatToOpenAIFunctionMessages(i.steps),
  },
  prompt,
 ...
 * @param {Array} conversationHistory - the ongoing conversation history
 * @param {number} retries - the number of retry attempts
 * @returns {Promise<Object>} - the final meal plan generated by the agent
 */
async function call_agent(input, conversationHistory, retries = 3) {
